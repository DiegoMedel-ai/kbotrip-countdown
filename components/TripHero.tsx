...
export function TripHero() {
  return (
    <header className="relative z-[2] w-full shrink-0 border-b border-white/[0.06] bg-gradient-to-b from-black/20 to-transparent px-4 pb-10 pt-[max(2.5rem,env(safe-area-inset-top))] sm:pb-12 sm:pt-12">
